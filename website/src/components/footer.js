      ...
      <div class="uk-grid uk-margin-medium-bottom uk-child-width-1-2@s uk-child-width-1-4@m" uk-grid>
        <div>
          <figure>
            ...
            <a href="https://www.jacobs-university.de" target="_blank">
        ...
        <div>
          ...
          <ul class="inline nolisticon">
            <li class="uk-margin-small-right">
              <a class="uk-icon-button bg-facebook" href="https://www.facebook.com/jacobsalumni" target="_blank">
            ...
            <li class="uk-margin-small-right">
              <a class="uk-icon-button bg-twitter" href="https://twitter.com/JacobsAlumni" target="_blank">
            ...
            <li class="uk-margin-small-right">
              <a class="uk-icon-button bg-instagram" href="https://www.instagram.com/jacobsalumni/" target="_blank">
            ...
            <li class="">
              <a class="uk-icon-button bg-linkedin" href="https://www.linkedin.com/groups/77362/profile" target="_blank">
